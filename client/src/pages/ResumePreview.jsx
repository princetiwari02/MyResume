...
function ResumePreview() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#050d1a] via-[#0a1628] to-[#050d1a] text-white py-10 px-6">
      ...
      <div
        className="max-w-4xl mx-auto bg-white text-black shadow-2xl rounded-lg overflow-auto"
        style={{
          maxHeight: "78vh",
          width: "88%",
        }}
            ...
            <div>
              ...
              {resumeData.personal.phone && (
                <div>
                  ...
                  <span style={{ color: BLUE2 }}>{resumeData.personal.phone}</span>
                </div>
              )}
            </div>
          </div>
              ...
              {resumeData.experience.map((exp, index) => (
                <div key={index} style={{ marginBottom: "12px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "2px" }}>
                    ...
                    <div style={{ fontSize: "9pt", color: BLUE2 }}>{exp.duration}</div>
                  </div>
                  <div style={{ fontSize: "10pt", color: BLACK, marginBottom: "4px" }}>{exp.title}</div>
          ...
          {resumeData.projects.length > 0 && (
            <div style={{ marginBottom: "16px" }}>
              ...
              {resumeData.projects.map((project, index) => (
                <div key={index} style={{ marginBottom: "12px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "2px" }}>
                    <div style={{ fontSize: "10pt", fontWeight: "700", color: BLUE2 }}>{project.title}</div>
                    {project.duration && (
                  ...
                  {project.tech && (
                    <div style={{ fontSize: "10pt", color: BLUE2, marginBottom: "4px" }}>Tech: {project.tech}</div>
                  )}
                  {project.liveLink && (
                    <div style={{ fontSize: "9pt", color: "#0066cc", marginBottom: "4px" }}>
                      <strong style={{ color: BLUE2 }}>Live:</strong>{" "}
                      <a href={project.liveLink} target="_blank" rel="noopener noreferrer" style={{ color: "#0066cc", textDecoration: "underline" }}>
                        {project.liveLink}
                      </a>
                    </div>
                  )}
              ...
              {resumeData.certificates.map((cert, index) => {
                ...
                return (
                  <div key={index} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "4px" }}>
                    <div style={{ fontSize: "10pt", color: BLACK, flex: 1 }}>{certText}</div>
              ...
              {resumeData.education.map((edu, index) => (
                <div key={index} style={{ marginBottom: "8px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                    <div style={{ fontSize: "10pt", fontWeight: "700", color: BLUE2 }}>{edu.institution}</div>
                    <div style={{ fontSize: "9pt", color: BLACK }}>{edu.location}</div>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
